...
//!
//! The primary entry point is [`OllamaIntelligence`], re-exported from
...
//! # #[tokio::main]
//! # async fn main() {
//! let intel = OllamaIntelligence::new("http://localhost:11434", "llama3");
...
pub use local_intelligence::OllamaIntelligence;
